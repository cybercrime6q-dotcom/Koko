...
async function loadUsers(){
  try{
    ...
    if(d.error&&!d.users?.length){
      document.getElementById('chat-list').innerHTML=`<div style="padding:28px;text-align:center;color:#f87171;font-size:13px;">Gagal memuat: ${d.error}</div>`;
      return;
    }
    allUsers=d.users||[];
    renderChatList();
    ...
    document.getElementById('chat-list').innerHTML='<div style="padding:28px;text-align:center;color:#f87171;font-size:13px;">Gagal terhubung ke server. Coba refresh.</div>';
